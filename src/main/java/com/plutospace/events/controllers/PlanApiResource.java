...
@Tag(name = "Plans Endpoints", description = "These endpoints manages plans on Elemoni")
...
public class PlanApiResource {
    ...
    @Operation(description = "This endpoint creates a new plan on Elemoni")
    public ResponseEntity<PlanResponse> createPlan(@RequestBody CreatePlanRequest createPlanRequest,
        ...
        String location = uriComponentsBuilder.path(PLANS_RESOURCE_ID).buildAndExpand(planResponse.getId()).toUriString();
